...
export default function Navbar({ onSearch }) {
    ...
    return (
        <nav className="px-2 sm:px-4 py-2.5 mb-1 rounded white:bg-white">
            <div className="container flex flex-wrap items-center justify-between">
                <div className="flex items-center">
                    ...
                    <Link to='/'>
                    <div className="flex">
                        <img src="youTube-icon.svg" className="h-6 ml-5 mr-2 mt-1 sm:h-5.5" alt="Youtube Logo" />
                ...
                <div className="flex items-center md:order-2">
                    <button type="button" id="dropdownUserAvatarButton" className="flex mx-auto text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdownAvatar" data-dropdown-placement="bottom">
